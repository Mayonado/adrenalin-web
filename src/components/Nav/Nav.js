...
const Nav = () => {
  ...
  return (
    <div className="bg-mobile-banner sm:bg-bannerImg min-h-mobile-banner sm:min-h-desktop-banner bg-no-repeat bg-cover grid grid-cols-2 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
